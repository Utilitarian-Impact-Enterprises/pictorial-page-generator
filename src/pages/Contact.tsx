                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              ...
                              className="bg-white bg-opacity-20 border-none text-white placeholder:text-white placeholder:text-opacity-50"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              ...
                              className="bg-white bg-opacity-20 border-none text-white placeholder:text-white placeholder:text-opacity-50 min-h-[150px]"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
